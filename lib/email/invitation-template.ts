...
<body style="margin:0;padding:40px 16px;background:#F5F5F2;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Malgun Gothic','Apple SD Gothic Neo',sans-serif;">
