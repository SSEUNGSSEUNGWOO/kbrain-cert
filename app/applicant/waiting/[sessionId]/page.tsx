    ...
    <div>
      ...
      <div className="border border-border rounded-md divide-y divide-border mb-6">
        <PledgeItem
          num="01"
          title="감독 방식"
          body="응시 중 웹캠·화면공유 스트림은 감독관에게 실시간 송출되지만 녹화·저장되지 않습니다. 문제 복사 시도·화면공유 중단 등 감독 이벤트만 기록됩니다. 외부 작업 도구 사용을 위한 탭·창 전환은 허용됩니다. (마이크 미사용)"
        />
        <PledgeItem
          num="02"
          title="부정행위 금지"
        ...
        <PledgeItem
          num="04"
          title="개인정보 처리"
          body="녹화 영상은 저장하지 않습니다. 신분증 이미지와 감독 이벤트 로그는 운영상 필요한 기간 동안만 보관됩니다."
        />
      </div>
